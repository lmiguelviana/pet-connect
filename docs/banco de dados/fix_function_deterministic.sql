-- CORREÇÃO DA FUNÇÃO get_user_company_id() PARA SER DETERMINÍSTICA
-- ================================================================
-- Este script corrige o problema de is_deterministic = NO na função
-- get_user_company_id(), melhorando performance e consistência das políticas RLS
...
-- Criar a função com configurações otimizadas
