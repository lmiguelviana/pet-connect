-- SCRIPT PARA CRIAR TABELAS DE PACOTES DE SERVIÇOS
-- ================================================
-- Execute este script no SQL Editor do Supabase para adicionar
-- as tabelas necessárias para o sistema de pacotes de serviços
...
-- Inserir alguns pacotes de exemplo (descomente se necessário)
/*
INSERT INTO service_packages (company_id, name, description, discount_type, discount_value, is_active)
VALUES 
  -- Substitua 'YOUR_COMPANY_ID' pelo ID real da empresa
  ('YOUR_COMPANY_ID', 'Pacote Completo', 'Banho + Tosa + Unha', 'percentage', 15.00, true),
  ('YOUR_COMPANY_ID', 'Pacote Básico', 'Banho + Escovação', 'fixed', 10.00, true);
*/

-- ================================================
-- SCRIPT CONCLUÍDO!
-- ================================================
-- Tabelas de pacotes de serviços criadas com sucesso:
...
-- 2. Teste a criação de pacotes via API
-- 3. Verifique se os preços são calculados automaticamente
-- ================================================